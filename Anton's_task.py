...
devision_result = {i+int(input_value / i):str(i)+','+str(int(input_value / i)) for i in range(int(min_val),int(10**(len(str(input_value))/2)))
                   if len(str(input_value / i)) == float_len}
