...
change_list={'January':'01', 'February':'02', 'March':'03', 'April':'04', 'May':'05'}
list_result = []

name = raw_input('Enter file name: ') #request file name
...
for row in handler: #analysis of each row
    ...
    result_var = match.group(3) +'-'+ tmp_var +'-'+ match.group(1) #create new row under result_var variable
